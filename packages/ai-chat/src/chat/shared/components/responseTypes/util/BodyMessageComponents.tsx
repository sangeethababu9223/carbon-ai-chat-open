...
function BodyMessageComponents(props: BodyMessageComponentsProps) {
      ...
      return (
        <div
          ...
          className={cx("WACBodyMessageComponents__MessageWrapper", {
            "WACBodyMessageComponents__MessageWrapper--fullWidth":
              isFullWidthMessage,
            "WACBodyMessageComponents__MessageWrapper--shortBottomPadding":
  ...
  return <div className="WACBodyMessageComponents">{messageComponents}</div>;
}
