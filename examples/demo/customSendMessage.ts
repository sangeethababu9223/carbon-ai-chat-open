...
![It is a cat!](https://web-chat.global.assistant.test.watson.appdomain.cloud/assets/cat-1950632_1280.jpg)
...
function doConversationalSearch(instance: ChatInstance) {
  const response = {
    ...
    citations: [
      {
        title: 'Independence National Historical Park (U.S. National Park Service)',
    ...
    search_results: [
      ...
      },
      {
        ...
        title: 'Discover our Shared Heritage - Heritage Travel (U.S. National Park Service)',
  ...
  if (request.input.text === '') {
    ...
    switch (request.input.text) {
      ...
      case 'conversational search':
        doConversationalSearch(instance as ChatInstance);
        break;
      case 'stream text':
